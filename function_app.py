...
from services.video_rag.api.functions.chat_message_functions import bp as bluetprint_chat_message_functions

app = func.FunctionApp()

# Register other functions
# app.register_blueprint(blueprint_service_test_functions)
app.register_blueprint(bluetprint_chat_message_functions)
